...
class AccessoryController extends Controllers\Controller
{
    public function getList(Request $request) // injecting dependency into controller (passing object of type Request)
    {
          ...
          if($priceFromIsInRange && $priceToIsInRange)
          {
            ...
            if($accessoryTypesExist && $stockTypeExists && $conditionExists)
            {
              ...
              if($currentPage != 0 && $totalNumOfProducts != 0)
              {
                ...
                $data['pages'] = \Paginator::build($totalNumOfProducts, 3, $numOfProductsToView, $currentPage, 2, 0);
      ...
      return View::make('contents.site.accessories.getAccessories', ['data' => $data]);
    }
    ...
    public function index()
    {
      ...
      return View::make('contents.site.accessories.index') -> with(['contentData' => $data,
    ...
    public function view($id)
    {
      ...
      if($data['accessoryExists'])
      {
        ...
        return View::make('contents.site.accessories.view', ['contentData' => $data,
    ...
    public function getAccessoriesForHomePage($id)
    {
      ...
      return View::make('contents.site.accessories.getAccessoriesForHomePage', ['accessories' => $accessories,
