...
use \App\Models\Site\ComputerCase;
...
class ComputerCaseController extends Controllers\Controller
{
    public function getList(Request $request)
    {
      ...
      return View::make('contents.site.computerCases.getComputerCases', ['data' => $data]);
    }
    ...
    public function index()
    {
      ...
      return View::make('contents.site.computerCases.index', ['contentData' => $data,
    ...
    public function view($id)
    {
      ...
      if($data['caseExists'])
      {
        ...
        return View::make('contents.site.computerCases.view', ['contentData' => $data,
                                                               'generalData' => $generalData]);
      }
