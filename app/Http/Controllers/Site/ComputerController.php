...
class ComputerController extends Controllers\Controller
{
    public function getList(Request $request)
    {
      ...
      return View::make('contents.site.computers.getComputers', ['data' => $data]);
    }
    ...
    public function getComputersForHomePage($id)
    {
      ...
      return View::make('contents.site.computers.getComputersForHomePage', ['computers' => $computers,
    ...
    public function view($id)
    {
       ...
       if($data['computerExists'])
       {
         ...
         return View::make('contents.site.computers.view', ['contentData' => $data,
                                                            'generalData' => $generalData]);
       }
