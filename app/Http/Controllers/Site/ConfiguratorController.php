...
use \App\Models\Site\Configurator;
...
class ConfiguratorController extends Controllers\Controller
{
    public function index()
    {
      ...
      return View::make('contents.site.configurator.index', ['generalData' => $generalData]);
    }
    ...
    public function getProcessors(Request $request)
    {
      ...
      return View::make('contents.site.configurator.getProcessors', ['data' => $data]);
    }
    ...
    public function getMotherboards(Request $request)
    {
      ...
      return View::make('contents.site.configurator.getMotherboards', ['data' => $data]);
    }
    ...
    public function getMemories(Request $request)
    {
      ...
      return View::make('contents.site.configurator.getMemories', ['data' => $data]);
    }
    ...
    public function getProcessorCoolers(Request $request)
    {
      ...
      return View::make('contents.site.configurator.getProcessorCoolers', ['data' => $data]);
    }
    ...
    public function getCases(Request $request)
    {
      ...
      return View::make('contents.site.configurator.getCases', ['data' => $data]);
    }
    ...
    public function getPowerSupplies(Request $request)
    {
      ...
      return View::make('contents.site.configurator.getPowerSupplies', ['data' => $data]);
    }
    ...
    public function getVideoCards(Request $request)
    {
      ...
      return View::make('contents.site.configurator.getVideoCards', ['data' => $data]);
    }
    ...
    public function getHardDiskDrives(Request $request)
    {
      ...
      return View::make('contents.site.configurator.getHardDiskDrives', ['data' => $data]);
    }
