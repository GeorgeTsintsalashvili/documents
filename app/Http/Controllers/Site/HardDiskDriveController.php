...
use \App\Models\Site\HardDiskDrive;
...
class HardDiskDriveController extends Controllers\Controller
{
    public function getList(Request $request)
    {
      ...
      return View::make('contents.site.hardDiskDrives.getHardDiskDrives', ['data' => $data]);
    }
    ...
    public function index()
    {
      ...
      return View::make('contents.site.hardDiskDrives.index', ['contentData' => $data,
    ...
    public function view($id)
    {
      ...
      if($data['hardDiskDriveExists'])
      {
        ...
        return View::make('contents.site.hardDiskDrives.view', ['contentData' => $data,
                                                                'generalData' => $generalData]);
      }
