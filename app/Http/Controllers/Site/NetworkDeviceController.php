...
use \App\Models\Site\NetworkDevice;
...
class NetworkDeviceController extends Controllers\Controller
{
    public function getList(Request $request)
    {
      ...
      return View::make('contents.site.networkDevices.getNetworkDevices', ['data' => $data]);
    }
    ...
    public function index()
    {
      ...
      return View::make('contents.site.networkDevices.index', ['contentData' => $data,
    ...
    public function view($id)
    {
      ...
      if($data['networkDeviceExists'])
      {
        ...
        return View::make('contents.site.networkDevices.view', ['contentData' => $data,
                                                                'generalData' => $generalData]);
      }
