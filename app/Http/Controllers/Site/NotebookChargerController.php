...
use \App\Models\Site\NotebookCharger;
...
class NotebookChargerController extends Controllers\Controller
{
    public function getList(Request $request)
    {
      ...
      return View::make('contents.site.notebookChargers.getNotebookChargers', ['data' => $data]);
    }
    ...
    public function index()
    {
      ...
      return View::make('contents.site.notebookChargers.index', ['contentData' => $data,
    ...
    public function view($id)
    {
      ...
      if($data['notebookChargerExists'])
      {
        ...
        \App\Models\Site\BaseModel::collectStatisticalData(NotebookCharger::class);

        return View::make('contents.site.notebookChargers.view', ['contentData' => $data,
                                                                  'generalData' => $generalData]);
      }
