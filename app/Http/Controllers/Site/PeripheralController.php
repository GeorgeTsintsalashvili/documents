...
use \App\Models\Site\Peripheral;
...
class PeripheralController extends Controllers\Controller
{
    public function getList(Request $request)
    {
      ...
      return View::make('contents.site.peripherals.getPeripherals', ['data' => $data]);
    }
    ...
    public function index()
    {
      ...
      return View::make('contents.site.peripherals.index', ['contentData' => $data,
    ...
    public function view($id)
    {
      ...
      if($data['peripheralExists'])
      {
        ...
        return View::make('contents.site.peripherals.view', ['contentData' => $data,
                                                             'generalData' => $generalData]);
      }
