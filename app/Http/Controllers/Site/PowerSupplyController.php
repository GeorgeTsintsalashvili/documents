...
use \App\Models\Site\PowerSupply;
...
class PowerSupplyController extends Controllers\Controller
{
    public function getList(Request $request)
    {
      ...
      return View::make('contents.site.powerSupplies.getPowerSupplies', ['data' => $data]);
    }
    ...
    public function index()
    {
      ...
      return View::make('contents.site.powerSupplies.index', ['contentData' => $data,
    ...
    public function view($id)
    {
      ...
      if($data['powerSupplyExists'])
      {
        ...
        return View::make('contents.site.powerSupplies.view', ['contentData' => $data,
                                                               'generalData' => $generalData]);
      }
