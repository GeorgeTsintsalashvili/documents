...
class ProcessorController extends Controllers\Controller
{
    public function getList(Request $request)
    {
      ...
      return View::make('contents.site.processors.getProcessors', ['data' => $data]);
    }
    ...
    public function index()
    {
      ...
      return View::make('contents.site.processors.index', ['contentData' => $data,
    ...
    public function view($id)
    {
      ...
      if($data['processorExists'])
      {
        ...
        return View::make('contents.site.processors.view', ['contentData' => $data,
                                                            'generalData' => $generalData]);
      }
