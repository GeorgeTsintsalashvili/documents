...
use \App\Models\Site\ProcessorCooler;
...
class ProcessorCoolerController extends Controllers\Controller
{
    public function getList(Request $request)
    {
      ...
      return View::make('contents.site.processorCoolers.getProcessorCoolers', ['data' => $data]);
    }
    ...
    public function index()
    {
      ...
      return View::make('contents.site.processorCoolers.index', ['contentData' => $data,
    ...
    public function view($id)
    {
      ...
      if($data['processorCoolerExists'])
      {
        ...
        return View::make('contents.site.processorCoolers.view', ['contentData' => $data,
                                                                  'generalData' => $generalData]);
      }
