...
use \App\Models\Site\UninterruptiblePowerSupply;
...
class UninterruptiblePowerSupplyController extends Controllers\Controller
{
    public function getList(Request $request)
    {
      ...
      return View::make('contents.site.uninterruptiblePowerSupplies.getUninterruptiblePowerSupplies', ['data' => $data]);
    }
    ...
    public function index()
    {
      ...
      return View::make('contents.site.uninterruptiblePowerSupplies.index', ['contentData' => $data,
    ...
    public function view($id)
    {
      ...
      if($data['uninterruptiblePowerSupplyExists'])
      {
        ...
        return View::make('contents.site.uninterruptiblePowerSupplies.view', ['contentData' => $data,
                                                                              'generalData' => $generalData]);
      }
