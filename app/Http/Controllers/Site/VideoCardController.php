...
class VideoCardController extends Controllers\Controller
{
    public function getList(Request $request)
    {
      ...
      return View::make('contents.site.videoCards.getVideoCards', ['data' => $data]);
    }
    ...
    public function index()
    {
      ...
      return View::make('contents.site.videoCards.index', ['contentData' => $data,
    ...
    public function view($id)
    {
      ...
      if($data['videoCardExists'])
      {
        ...
        return View::make('contents.site.videoCards.view', ['contentData' => $data,
                                                            'generalData' => $generalData]);
      }
