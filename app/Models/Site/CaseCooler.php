...
class CaseCooler extends Model
{
    ...
    public function getCaseCoolersData()
    {
      $numOfProductsToView = 6;
      $adjacent = 3;
      $currentPage = 1;
    ...
    public function getCaseCoolerData($id, $seoFields)
    {
      ...
      {
        $seoFields -> description = $data['caseCooler'] -> seoDescription;
        $seoFields -> keywords = $data['caseCooler'] -> seoKeywords;
        $seoFields -> title = $data['caseCooler'] -> title;
        ...
        $data['caseCooler'] -> categoryId = BaseModel::getTableAliasByModelName(self::class);
