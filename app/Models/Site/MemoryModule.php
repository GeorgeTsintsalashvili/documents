...
class MemoryModule extends Model
{
    ...
    public function getMemoryModulesData()
    {
      ...
      if($data['configuration']['productPriceRangeExists'])
      {
        ...
        if($totalNumberOfProducts != 0)
        {
          ...
          $data['memoryModules'] = $data['memoryModules'] -> chunk($chunkSize);
        }
      }
    ...
    public function getMemoryModuleData($id, $seoFields)
    {
      $numOfProductsToView = 12;
      $pricePart = 0.2;
      ...
      {
        $seoFields -> description = $data['memoryModule'] -> seoDescription;
        $seoFields -> keywords = $data['memoryModule'] -> seoKeywords;
        $seoFields -> title = $data['memoryModule'] -> title;
        ...
        $data['memoryModule'] -> categoryId = BaseModel::getTableAliasByModelName(self::class);
