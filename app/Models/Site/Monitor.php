...
class Monitor extends Model
{
    ...
    public function getMonitorsData()
    {
      ...
      if($data['configuration']['productPriceRangeExists'])
      {
        ...
        if($data['monitorsExist'])
        {
          ...
          $data['monitors'] = $data['monitors'] -> chunk($chunkSize);
        }
      }
    ...
    public function getMonitorData($id, $seoFields)
    {
      ...
      {
        $seoFields -> description = $data['monitor'] -> seoDescription;
        $seoFields -> keywords = $data['monitor'] -> seoKeywords;
        $seoFields -> title = $data['monitor'] -> title;
        ...
        $data['monitor'] -> categoryId = BaseModel::getTableAliasByModelName(self::class);
