...
class OpticalDiscDrive extends Model
{
    ...
    public function getOpticalDiscDrivesData()
    {
      $numOfProductsToView = 6;
      $adjacent = 3;
      $currentPage = 1;
    ...
    public function getOpticalDiscDriveData($id, $seoFields)
    {
      ...
      {
        $seoFields -> description = $data['opticalDiscDrive'] -> seoDescription;
        $seoFields -> keywords = $data['opticalDiscDrive'] -> seoKeywords;
        $seoFields -> title = $data['opticalDiscDrive'] -> title;
        ...
        $data['opticalDiscDrive'] -> categoryId = BaseModel::getTableAliasByModelName(self::class);
