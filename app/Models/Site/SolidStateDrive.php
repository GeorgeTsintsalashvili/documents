...
class SolidStateDrive extends Model
{
    ...
    public function getSolidStateDrivesData()
    {
    ...
    public function getSolidStateDriveData($id, $seoFields)
    {
       ...
       {
         $seoFields -> description = $data['solidStateDrive'] -> seoDescription;
         $seoFields -> keywords = $data['solidStateDrive'] -> seoKeywords;
         $seoFields -> title = $data['solidStateDrive'] -> title;
         ...
         $data['solidStateDrive'] -> categoryId = BaseModel::getTableAliasByModelName(self::class);
