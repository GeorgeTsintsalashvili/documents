					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								...
								<span class="last-breadcrumb-part font-3">კეისები</span>
							</div>
						</div>
					</div>
			</div>
									...
									<div id="left_column" class="column col-xs-12 col-sm-3 filter">
												 ...
												 <div id="layered_block_left" class="block">
														 <div class="block_content filter-item-1">
																 <form action="{{ route('casesLoad') }}" class="filter-form" method="post" id="layered_form">
																		<div class="filter-form-container">
																			...
																			<div class="layered_price">
																					...
																					<ul id="ul_layered_price_0" class="col-lg-12 layered_filter_ul">
																							<div id="price-range" data-min-price="{{ $contentData['configuration']['productPriceRange'] -> computerCaseMinPrice }}" data-max-price="{{ $contentData['configuration']['productPriceRange'] -> computerCaseMaxPrice }}">
																							...
																							<input type="hidden" class="slider-input" value="{{ $contentData['configuration']['productPriceRange'] -> computerCaseMinPrice }}, {{ $contentData['configuration']['productPriceRange'] -> computerCaseMaxPrice }}"/>
																					</ul>
																			</div>
																		<!--- Price filter end --->
																		...
																		<!--- Case form factor filter start --->
																			...
																			<div class="layered_filter">
																					<h2 class="title_block">
																						<span class="font-3">ფორმ-ფაქტორი</span>
																					</h2>
																					<ul class="col-lg-12 layered_filter_ul">

																						@foreach($contentData['configuration']['formFactors'] as $key => $value)
																							<li class="nomargin hiddable col-lg-12">
																									<input type="checkbox" class="checkbox" value="{{ $value -> id }}" data-active="0" data-hidden-input="form-factor"/>
																									<label for="">
																											<a href="#" data-rel="nofollow">
																												<b class="font-4">{{ $value -> formFactorTitle }}</b>
									...
									<div id="center_column" class="center_column dor-two-cols col-xs-12 col-sm-9">
										...
										<!-- Products list -->
										 ...
										 <div id="result-content">
											@foreach($contentData['cases'] as $index => $row)
																	 ...
																	 <div class="dor-display-product-info">
																			 <div class="left-block">
																					 <div class="product-image-container">
																							 <a class="product_img_link" target="_blank" href="/computerCases/{{ $value -> caseId }}" title="{{ $value -> title }}">
																								<img class="replace-2x img-responsive" src="/images/computerCases/main/original/{{ $value -> mainImage }}" width="450" height="478"/>
																							 </a>
																					...
																					<div class="right-block">
																							<h5>
																							 <a class="product-name font-4" target="_blank" href="/computerCases/{{ $value -> caseId }}" title="{{ $value -> title }}">
																									...
																									<div class="product-flags">
																										...
																										<div class="product-more-options">
																												<div class="read-more-container">
																														<a class="button read-more-button btn btn-default" target="_blank" href="/computerCases/{{ $value -> caseId }}">
