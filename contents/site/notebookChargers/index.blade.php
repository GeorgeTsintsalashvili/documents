					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								...
								<span class="last-breadcrumb-part font-3">ნოუთბუქის დამტენები</span>
							</div>
						</div>
					</div>
			</div>
							...
							<div class="row">
									<div id="left_column" class="column col-xs-12 col-sm-3 filter">
												 ...
												 <div id="layered_block_left" class="block">
														 <div class="block_content filter-item-1">
																 <form action="{{ route('ncLoad') }}" class="filter-form" method="post" id="layered_form">
																		<div class="filter-form-container">
																			...
																			<div class="layered_price">
																					...
																					<ul id="ul_layered_price_0" class="col-lg-12 layered_filter_ul">
																							<div id="price-range" data-min-price="{{ $contentData['configuration']['productPriceRange'] -> notebookChargerMinPrice }}" data-max-price="{{ $contentData['configuration']['productPriceRange'] -> notebookChargerMaxPrice }}">
																							...
																							<input type="hidden" class="slider-input" value="{{ $contentData['configuration']['productPriceRange'] -> notebookChargerMinPrice }}, {{ $contentData['configuration']['productPriceRange'] -> notebookChargerMaxPrice }}"/>
																					</ul>
																			</div>
																		<!--- Price filter end --->
                                    ...
                                    <!--- Manufacturer filter start -->
                                      ...
                                      <div class="layered_filter">
                                          <h2 class="title_block">
                                           <span class="font-3">ბრენდი</span>
                                         </h2>
                                        <ul class="col-lg-12 layered_filter_ul">
                                         @foreach($contentData['configuration']['manufacturers'] as $value)
                                            <li class="nomargin hiddable col-lg-12">
                                                <input type="checkbox" class="checkbox" value="{{ $value -> id }}" data-active="0" data-hidden-input="manufacturer"/>
                                                <label for="">
                                  ...
                                  <!--- Stock type filter end --->
									...
									<div id="center_column" class="center_column dor-two-cols col-xs-12 col-sm-9">
										 ...
										 <div id="result-content">
											@foreach($contentData['notebookChargers'] as $row)
																	 ...
																	 <div class="dor-display-product-info">
																			 <div class="left-block">
																					 <div class="product-image-container">
																							 <a class="product_img_link" target="_blank" href="/notebookChargers/{{ $value -> id }}" title="{{ $value -> title }}">
																								<img class="replace-2x img-responsive" src="/images/notebookChargers/main/original/{{ $value -> mainImage }}" width="450" height="478"/>
																							 </a>
																					...
																					<div class="right-block">
																							<h5>
																							 <a class="product-name font-4" target="_blank" href="/notebookChargers/{{ $value -> id }}" title="{{ $value -> title }}">
																									...
																									<div class="product-flags">
																										...
																										<div class="product-more-options">
																												<div class="read-more-container">
																														<a class="button read-more-button btn btn-default" target="_blank" href="/notebookChargers/{{ $value -> id }}">
