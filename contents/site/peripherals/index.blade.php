					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								...
								<span class="last-breadcrumb-part font-3">პერიფერიალები</span>
							</div>
						</div>
					</div>
			</div>
									...
									<div id="left_column" class="column col-xs-12 col-sm-3 filter">
												 ...
												 <div id="layered_block_left" class="block">
														 <div class="block_content filter-item-1">
																 <form action="{{ route('perLoad') }}" class="filter-form" method="post" id="layered_form">
																		<div class="filter-form-container">
																			...
																			<div class="layered_price">
																					...
																					<ul id="ul_layered_price_0" class="col-lg-12 layered_filter_ul">
																							<div id="price-range" data-min-price="{{ $contentData['configuration']['productPriceRange'] -> peripheralMinPrice }}" data-max-price="{{ $contentData['configuration']['productPriceRange'] -> peripheralMaxPrice }}">
																							...
																							<input type="hidden" class="slider-input" value="{{ $contentData['configuration']['productPriceRange'] -> peripheralMinPrice }}, {{ $contentData['configuration']['productPriceRange'] -> peripheralMaxPrice }}"/>
																					</ul>
																			</div>
																		<!--- Price filter end --->
                                  ...
                                  <!--- Stock type filter end --->
									...
									<div id="center_column" class="center_column dor-two-cols col-xs-12 col-sm-9">
										 ...
										 <div id="result-content">
											@foreach($contentData['peripherals'] as $row)
																	 ...
																	 <div class="dor-display-product-info">
																			 <div class="left-block">
																					 <div class="product-image-container">
																							 <a class="product_img_link" target="_blank" href="/peripherals/{{ $value -> id }}" title="{{ $value -> title }}">
