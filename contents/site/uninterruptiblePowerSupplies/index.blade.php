					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								...
								<span class="last-breadcrumb-part font-3">უწყვეტის კვების წყარო</span>
							</div>
						</div>
					</div>
			</div>
									...
									<div id="left_column" class="column col-xs-12 col-sm-3 filter">
												 ...
												 <div id="layered_block_left" class="block">
														 <div class="block_content filter-item-1">
																 <form action="{{ route('upsLoad') }}" class="filter-form" method="post" id="layered_form">
																		<div class="filter-form-container">

																			<!--- Order and visibility params ------>

																			<input name="order" type="hidden" class="order" value="0">
																			<input name="numOfProductsToShow" type="hidden" class="numOfProductsToShow" value="6">
																			...
																			<div class="layered_price">
																					...
																					<ul id="ul_layered_price_0" class="col-lg-12 layered_filter_ul">
																							<div id="price-range" data-min-price="{{ $contentData['configuration']['productPriceRange'] -> uninterruptiblePowerSupplyMinPrice }}" data-max-price="{{ $contentData['configuration']['productPriceRange'] -> uninterruptiblePowerSupplyMaxPrice }}">
																							...
																							<input type="hidden" class="slider-input" value="{{ $contentData['configuration']['productPriceRange'] -> uninterruptiblePowerSupplyMinPrice }}, {{ $contentData['configuration']['productPriceRange'] -> uninterruptiblePowerSupplyMaxPrice }}"/>
																					</ul>
																			</div>
																		<!--- Price filter end -------->
																			...
																			<!--- Power filter start -------->
																				...
																				<div class="layered_filter">
																						<h2 class="title_block">
																						 <span class="font-3">სიმძლავრე</span>
																					 </h2>
																					 <ul id="ul_layered_price_0" class="col-lg-12 layered_filter_ul">
 																							<div id="power-range">
 																							 <span class="from-sign">W</span>
									...
									<div id="center_column" class="center_column dor-two-cols col-xs-12 col-sm-9">
															...
															<form id="productsSortForm" action="#" class="productsSortForm">
																	<div class="select selector1">
																			...
																			<select id="selectProductSort" class="selectProductSort selectpicker">
																					...
																					<option value="3">სიმძლავრის კლებადობით</option>
																					<option value="4">სიმძლავრის ზრდადობით</option>
										...
										<!-- Products list -->
										 <div id="result-content">
											@foreach($contentData['uninterruptiblePowerSupplies'] as $index => $row)
																	 ...
																	 <div class="dor-display-product-info">
																			 <div class="left-block">
																					 <div class="product-image-container">
																							 <a class="product_img_link" target="_blank" href="/uninterruptiblePowerSupplies/{{ $value -> id }}" title="{{ $value -> title }}">
																								<img class="replace-2x img-responsive" src="/images/uninterruptiblePowerSupplies/main/original/{{ $value -> mainImage }}" width="450" height="478"/>
																							 </a>
																					...
																					<div class="right-block">
																							<h5>
																							 <a class="product-name font-4" target="_blank" href="/uninterruptiblePowerSupplies/{{ $value -> id }}" title="{{ $value -> title }}">
																									...
																									<div class="product-flags">
																										...
																										<div class="product-more-options">
																												<div class="read-more-container">
																														<a class="button read-more-button btn btn-default" target="_blank" href="/uninterruptiblePowerSupplies/{{ $value -> id }}">
