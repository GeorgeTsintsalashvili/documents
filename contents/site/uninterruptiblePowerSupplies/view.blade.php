          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                ...
                <a class="breadcrumb-part breadcrumb-link-1" href="/uninterruptiblePowerSupplies">
                  <span class="font-3">უწყვეტი კვების წყარო</span>
                </a>
                <span class="last-breadcrumb-part font-4">{{ $contentData['uninterruptiblePowerSupply'] -> title }}</span>
              </div>
            </div>
          </div>
      </div>
                                ...
                                <div class="pb-left-column col-md-6 col-sm-12 col-xs-12 media">
                                   <div class="image-block-wrapper">
                                    ...
                                    <div id="image-block" class="clearfix">
                                        ...
                                        <img id="bigpic" data-itemprop="image" src="/images/uninterruptiblePowerSupplies/main/original/{{ $contentData['uninterruptiblePowerSupply'] -> mainImage }}" width="800" height="850" />
                                       ...
                                       <div id="views_block" class="clearfix ">
                                          ...
                                          <div id="thumbs_list">
                                              <ul id="thumbs_list_frame">
                                                <li>
                                                  <a href="/images/uninterruptiblePowerSupplies/main/original/{{ $contentData['uninterruptiblePowerSupply'] -> mainImage }}" data-fancybox-group="other-views" class="fancybox shown">
                                                    <img class="img-responsive" src="/images/uninterruptiblePowerSupplies/main/preview/{{ $contentData['uninterruptiblePowerSupply'] -> mainImage }}" height="266" width="250" data-itemprop="image" />
                                                  </a>
                                                </li>
                                                @if($contentData['imagesExist'])

                                                @foreach($contentData['images'] as $key => $value)
                                                  <li>
                                                    <a href="/images/uninterruptiblePowerSupplies/slides/original/{{ $value -> image }}" data-fancybox-group="other-views" class="fancybox shown">
                                                      <img class="img-responsive" src="/images/uninterruptiblePowerSupplies/slides/preview/{{ $value -> image }}" height="266" width="250" data-itemprop="image" />
                                                    </a>
                                                  </li>
                                                @endforeach
                                              @endif
                                ...
                                <div class="pb-center-column col-md-6 col-sm-12 col-xs-12 info">
                                    ...
                                    <div class="product_title_wrapper">
                                        <div class="product_title entry-title" data-itemprop="name">
                                            <h1 class="font-4" data-itemprop="name">{{ $contentData['uninterruptiblePowerSupply'] -> title }}</h1>
                                        </div>
                                    </div>
                                    ...
                                    <div class="content_prices clearfix">
                                        ...
                                        <div>
                                          <p class="our_price_display font-4 fsz-18 no-mrgn price">
                                            <span id="our_price_display" class="price" data-itemprop="price" content="1000"><b>₾</b> {{ $contentData['uninterruptiblePowerSupply'] -> newPrice }}</span>
                                          </p>
                                          @if($contentData['uninterruptiblePowerSupply'] -> discount != 0)
                                            <p id="old_price" class="font-3 fsz-18 no-mrgn">
                                              <span id="old_price_display">
                                                <span class="price font-4 fsz-18 no-mrgn"><b>₾</b> {{ $contentData['uninterruptiblePowerSupply'] -> price }}</span>
                                              </span>
                                            </p>
                                          @endif
                                        </div>
                                    ...
                                    <p id="product-warranty">
                                       ...
                                       <span class="font-4">მოქმედებს {{ $contentData['uninterruptiblePowerSupply'] -> warrantyDuration }} {{ $contentData['warrantyTitle'] }} გარანტია საუკეთესო პირობებით</span>
                                    </p>
                                    ...
                                    <p id="product-code">
                                       ...
                                       <span>{{ $contentData['uninterruptiblePowerSupply'] -> code }} </span> <br>
                                    </p>

                                    @if($contentData['uninterruptiblePowerSupply'] -> quantity != 0)
                                    <p id="product-quantity">
                                       <b class="font-3">საერთო რაოდენობა </b>
                                       <span>{{ $contentData['uninterruptiblePowerSupply'] -> quantity }}</span> <br>
                                    </p>
                                    @endif
                                    ...
                                    <div class="social-networks-wrapper">
                                     <div class="fb-share-button" data-href="/uninterruptiblePowerSupplies/{{ $contentData['uninterruptiblePowerSupply'] -> id }}" data-size="small" data-layout="button_count" style="position: absolute"></div>
                                    ...
                                    <form id="buy_block" action="/shoppingCart/add" method="post" data-allowed-quantity="{{ $contentData['uninterruptiblePowerSupply'] -> quantity }}">
                                                        ...
                                                        <div class="techspecs-column">
                                                            <div class="column large-12 small-12 small-push-0">
                                                                <div class="product-description">
                                                                  {!! $contentData['uninterruptiblePowerSupply'] -> description !!}
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                               ...
                                                                               <div class="product-container">
                                                                                   <div class="dor-display-product-info">
                                                                                       ...
                                                                                       <div class="left-block">
                                                                                           <div class="product-image-container">
                                                                                               <a class="product_img_link" href="/uninterruptiblePowerSupplies/{{ $value -> id }}">
                                                                                                   <img class="replace-2x img-responsive" src="/images/uninterruptiblePowerSupplies/main/original/{{ $value -> mainImage }}"/>
                                                                                               </a>
                                                                                           </div>
                                                                                       </div>
                                                                                       ...
                                                                                       <div class="right-block">
                                                                                           <h5>
                                                                                           <a class="product-name font-4" href="/uninterruptiblePowerSupplies/{{ $value -> id }}">
                                                                                 ...
                                                                                 <div class="product-more-options">
                                                                                  <div class="read-more-container">
                                                                                     <a class="button read-more-button btn btn-default" href="/uninterruptiblePowerSupplies/{{ $value -> id }}">
