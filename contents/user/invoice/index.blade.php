	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="font-mtavruli">ინვოისი</h4>
			</div>
           ...
           <div class="tab-pane active" id="invoice-form">
             ...
             <form class="form-horizontal row-border" method="POST" action="{{ route('displayInvoice') }}" data-send-address="{{ route('sendInvoice') }}">
  						...
  						<div class="form-group">
  						 ...
  						 <label class="col-sm-1 control-label font-4">კოდი</label>
  						 <div class="col-sm-3">
  							 <input data-allowed-empty type="text" class="form-control" name="code">
  						 </div>

               <label class="col-sm-1 control-label font-4">სახელი</label>
  						 <div class="col-sm-3">
  							 <input data-allowed-empty type="text" class="form-control" name="name">
  						 </div>
              ...
              <div class="form-group">
               ...
               <label class="col-sm-1 control-label font-4">ტელეფონი</label>
               <div class="col-sm-3">
                 <input data-allowed-empty type="text" class="form-control" name="phone">
               </div>

               <label class="col-sm-1 control-label font-4">მისამართი</label>
               <div class="col-sm-3">
                 <input data-allowed-empty type="text" class="form-control" name="address">
               </div>
              ...
              <div class="form-group">
                ...
                <label class="col-sm-1 control-label font-4">Email</label>
                <div class="col-sm-3">
                  <input data-allowed-empty type="text" class="form-control" name="email">
                </div>

                <label class="col-sm-1 control-label font-4">ID</label>
                <div class="col-sm-3">
							...
							<div class="panel-footer">
	 							<div class="row">
	 								<div class="col-sm-5 col-sm-offset-1">
	 									<input type="submit" class="btn-primary btn font-4 mr10" value="დაბეჭდვა">
										<input id="send-invoice" type="button" class="btn-primary btn font-4 mr10" value="გაგზავნა">
										<input type="button" data-storage="invoiceProducts" class="btn-primary btn font-4 mr4 clear-form" value="გასუფთავება">
	 								</div>
									<div class="col-sm-6 text-right" style="font-size: 20px">
										<b class="font-4" style="color: #247c6c"> სრული თანხა </b>
										<span class="total-price font-4">0</span>
...
@include('parts.user.generatedFormController')
...
@include('parts.user.priceAndQuantityChangeHandler')
@include('parts.user.titleAndWarrantyChangeHandler')
