	...
	<div class="col-xs-8">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="font-mtavruli">დისკმძრავის ტიპები</h4>
			</div>
          ...
          @foreach($oddTypes as $value)
              ...
              <!--- Title field --->
							<td>
								<input data-parameter-name="odd-type-title" type="text" value="{{ $value -> typeTitle }}" class="no-border transparent-bg-color font-4 field">
							</td>
       ...
       <form action="{{ route('oddtStore') }}" method="post" class="form-horizontal row-border data-form" enctype="multipart/form-data">
          ...
          <div class="col-sm-3">
            <input type="submit" class="btn-primary btn font-4" value="დამატება">
 					...
 					<div class="col-sm-4">
 						<input name="odd-type-title" type="text" class="form-control font-4" placeholder="დასახელება">
 					</div>
        </div>
      </form>
