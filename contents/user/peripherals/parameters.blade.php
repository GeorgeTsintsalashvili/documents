	...
	<div class="col-xs-8">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="font-mtavruli">პერიფერიალების ტიპები</h4>
			</div>
          ...
          @foreach($peripheralsTypes as $value)
              ...
              <!--- Title field --->
							<td>
								<input data-parameter-name="peripheral-type-title" type="text" value="{{ $value -> typeTitle }}" class="no-border transparent-bg-color font-4 field">
							</td>

							<!--- Icon field ---->
							<td>
								<input data-parameter-name="peripheral-type-icon" type="text" value="{{ $value -> icon }}" class="no-border transparent-bg-color font-4 field">
							</td>
       ...
       <form action="{{ route('peripheralTypeStore') }}" method="post" class="form-horizontal row-border data-form" enctype="multipart/form-data">
          ...
          <div class="col-sm-2">
            <input type="submit" class="btn-primary btn font-4" value="დამატება">
 					...
 					<div class="col-sm-5">
 						<input name="peripheral-type-title" type="text" class="form-control font-4" placeholder="დასახელება">
 					</div>
					<div class="col-sm-5">
						<input name="peripheral-type-icon" type="text" class="form-control font-4" placeholder="სიმბოლოს კოდი (არასავალდებულო)">
					</div>
        </div>
      </form>
