	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="font-mtavruli p-abs">საგარანტიო</h4>
				<div class="options">
				 <ul class="nav nav-tabs">
					 <li class="active">
						 <a href="#parts-warranty" data-toggle="tab" class="font-4">ნაწილების</a>
					 </li>
					 <li>
						 <a href="#computer-warranty" data-toggle="tab" class="font-4">სისტემური ბლოკის</a>
					 </li>
				 </ul>
				</div>
			</div>
				 ...
				 <div class="tab-pane active" id="parts-warranty">
					 ...
					 <form class="form-horizontal row-border" method="POST" action="{{ route('displayWarranty') }}">
						<div class="form-group">
							<label class="col-sm-1 control-label font-4">პ/ნ</label>
						 <div class="col-sm-3">
							 <input type="text" class="form-control" name="clientId">
							 <input type="hidden" class="form-control" name="incrp" value="0">
						 </div>
						</div>
						<div class="form-group">
							<label class="col-sm-1 control-label font-4">მენეჯერი</label>
						 <div class="col-sm-3">
							 <select class="manager wpr-100" name="manager">
								 @foreach($managers as $manager)
									 <option class="font-4" value="{{ $manager -> name }}">{{ $manager -> name }}</option>
								 @endforeach
							 </select>
						 </div>
						</div>
 						<div class="panel-footer">
							<div class="row">
 								<div class="col-sm-5 col-sm-offset-1">
									...
									<input type="button" data-storage="warrantyProducts" class="btn-primary btn font-4 mr4 clear-form" value="გასუფთავება">
 								</div>
 						...
 						<div class="panel-footer">
 							<div class="row">
 								<div class="col-sm-3 col-sm-offset-1">
 									<input type="submit" class="btn-primary btn font-4 mr10" value="დაბეჭდვა">
									<input type="button" data-storage="warrantyComputer" class="btn-primary btn font-4 mr4 clear-form" value="გასუფთავება">
 								</div>
