          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                ...
                <a class="breadcrumb-part breadcrumb-link-1" href="/accessories">
                  <span class="font-3">აქსესუარები</span>
                </a>
                <span class="last-breadcrumb-part font-4"> {{ $contentData['accessory'] -> title }} </span>
              </div>
            </div>
          </div>
      </div>
                                ...
                                <div class="pb-left-column col-md-6 col-sm-12 col-xs-12 media">
                                   <div class="image-block-wrapper">
                                    ...
                                    <div id="image-block" class="clearfix">
                                        ...
                                        <img id="bigpic" data-itemprop="image" src="/images/accessories/main/original/{{ $contentData['accessory'] -> mainImage }}" width="800" height="850" />
                                       ...
                                       <div id="views_block" class="clearfix ">
                                          ...
                                          <div id="thumbs_list">
                                              <ul id="thumbs_list_frame">
                                                <li>
                                                  <a href="/images/accessories/main/original/{{ $contentData['accessory'] -> mainImage }}" data-fancybox-group="other-views" class="fancybox shown">
                                                    <img class="img-responsive" src="/images/accessories/main/preview/{{ $contentData['accessory'] -> mainImage }}" height="266" width="250" data-itemprop="image" />
                                                  </a>
                                                </li>
                                                ...
                                                @foreach($contentData['images'] as $value)
                                                  <li>
                                                    <a href="/images/accessories/slides/original/{{ $value -> image }}" data-fancybox-group="other-views" class="fancybox shown">
                                                      <img class="img-responsive" src="/images/accessories/slides/preview/{{ $value -> image }}" height="266" width="250" data-itemprop="image" />
                                                    </a>
                                                  </li>
                                                @endforeach
                                ...
                                <div class="pb-center-column col-md-6 col-sm-12 col-xs-12 info">
                                    ...
                                    <div class="product_title_wrapper">
                                        <div class="product_title entry-title" data-itemprop="name">
                                            <h1 class="font-4" data-itemprop="name">{{ $contentData['accessory'] -> title }}</h1>
                                        </div>
                                    </div>
                                    ...
                                    <div class="content_prices clearfix">
                                        ...
                                        <div>
                                          <p class="our_price_display font-4 fsz-18 no-mrgn price">
                                            <span id="our_price_display" class="price" data-itemprop="price"><b>₾</b> {{ $contentData['accessory'] -> newPrice }} </span>
                                          </p>
                                          @if($contentData['accessory'] -> discount != 0)
                                            <p id="old_price" class="fsz-18 no-mrgn">
                                              <span id="old_price_display">
                                                <span class="price font-4 fsz-18 no-mrgn"><b>₾</b> {{ $contentData['accessory'] -> price }}</span>
                                              </span>
                                            </p>
                                          @endif
                                        </div>
                                    ...
                                    <p id="product-warranty">
                                       ...
                                       <span class="font-4">მოქმედებს {{ $contentData['accessory'] -> warrantyDuration }} {{ $contentData['warrantyTitle'] }} გარანტია საუკეთესო პირობებით</span>
                                    </p>
                                    ...
                                    <div class="social-networks-wrapper">
                                     <div class="fb-share-button" data-href="/accessories/{{ $contentData['accessory'] -> id }}" data-size="small" data-layout="button_count" style="position: absolute"></div>
                                    ...
                                    <form id="buy_block" action="/shoppingCart/add" method="post" data-allowed-quantity="{{ $contentData['accessory'] -> quantity }}">
                                                        ...
                                                        <div class="techspecs-column">
                                                            <div class="column large-12 small-12 small-push-0">
                                                                <div class="product-description">
                                                                  {!! $contentData['accessory'] -> description !!}
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                                   ...
                                                                                   <div class="dor-display-product-info">
                                                                                       ...
                                                                                       <div class="left-block">
                                                                                           <div class="product-image-container">
                                                                                               <a class="product_img_link" href="/accessories/{{ $value -> id }}">
                                                                                                   <img class="replace-2x img-responsive" src="/images/accessories/main/original/{{ $value -> mainImage }}"/>
                                                                                               </a>
                                                                                           </div>
                                                                                       </div>
                                                                                       ...
                                                                                       <div class="right-block">
                                                                                           <h5>
                                                                                           <a class="product-name font-4" href="/accessories/{{ $value -> id }}">
