					...
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								...
								<span class="last-breadcrumb-part font-3">HDD მეხსიერება</span>
							</div>
						</div>
					</div>
			</div>
									...
									<div id="left_column" class="column col-xs-12 col-sm-3 filter">
												 ...
												 <div id="layered_block_left" class="block">
														 <div class="block_content filter-item-1">
																 <form action="{{ route('hddLoad') }}" class="filter-form" method="post" id="layered_form">
																		<div class="filter-form-container">
																			...
																			<div class="layered_price">
																					...
																					<ul id="ul_layered_price_0" class="col-lg-12 layered_filter_ul">
																							<div id="price-range" data-min-price="{{ $contentData['configuration']['productPriceRange'] -> hardDiskDriveMinPrice }}" data-max-price="{{ $contentData['configuration']['productPriceRange'] -> hardDiskDriveMaxPrice }}">
																							...
																							<input type="hidden" class="slider-input" value="{{ $contentData['configuration']['productPriceRange'] -> hardDiskDriveMinPrice }}, {{ $contentData['configuration']['productPriceRange'] -> hardDiskDriveMaxPrice }}"/>
																					</ul>
																			</div>
																		...
																		<!--- Capacity filter start ----->
																			...
																			<div class="layered_filter">
 																			...
 																			<div class="layered_filter">
 																					<h2 class="title_block">
 																						<span class="font-3">ბრუნვის სიჩქარე</span>
 																					</h2>
 																					<ul class="col-lg-12 layered_filter_ul">
 																						@foreach($contentData['configuration']['rpm'] as $key => $value)
 																							<li class="nomargin hiddable col-lg-12">
 																									<input type="checkbox" class="checkbox" value="{{ $value -> rpm }}" data-active="0" data-hidden-input="rpm"/>
 																									<label for="">
 																											<a href="#" data-rel="nofollow">
 																												<b>{{ $value -> rpm }} <span class="font-4"> ბრ/წთ</span></b>
 																												<span> ({{ $value -> numOfProducts }})</span>
 																											</a>
 																									</label>
 																							 </li>
                                  ...
                                  <!--- Stock type filter end ---->
									...
									<div id="center_column" class="center_column dor-two-cols col-xs-12 col-sm-9">
															...
															<form id="productsSortForm" action="#" class="productsSortForm">
																	<div class="select selector1">
																			...
																			<select id="selectProductSort" class="selectProductSort selectpicker">
																					...
																					<option value="5">სიჩქარის კლებადობით</option>
																					<option value="6">სიჩქარის ზრდადობით</option>
										 ...
										 <div id="result-content">
											...
											@foreach($contentData['hardDiskDrives'] as $index => $row)
																	 ...
																	 <div class="dor-display-product-info">
																			 <div class="left-block">
																					 <div class="product-image-container">
																							 <a class="product_img_link" target="_blank" href="/hardDiskDrives/{{ $value -> id }}" title="{{ $value -> title }}">
																								<img class="replace-2x img-responsive" src="/images/hardDiskDrives/main/original/{{ $value -> mainImage }}" width="450" height="478"/>
																							 </a>
																					...
																					<div class="right-block">
																							<h5>
																							 <a class="product-name font-4" target="_blank" href="/hardDiskDrives/{{ $value -> id }}" title="{{ $value -> title }}">
																									...
																									<div class="product-flags">
																										...
																										<div class="product-more-options">
																												<div class="read-more-container">
																														<a class="button read-more-button btn btn-default" target="_blank" href="/hardDiskDrives/{{ $value -> id }}">
