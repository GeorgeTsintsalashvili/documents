                         ...
                         <table id="cart_summary" class="table table-bordered stock-management-on">
                             ...
                             <tbody>
                                ...
                                @foreach($contentData['products'] as $value)
                                 ...
                                 <tr id="product_18_144_0_0" class="cart_item first_item address_0 odd" data-category-id="{{ $value -> categoryId }}" data-product-id="{{ $value -> id }}" data-max-quantity="{{ $value -> quantity }}">
