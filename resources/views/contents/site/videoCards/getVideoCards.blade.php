               ...
               <div class="dor-display-product-info">
                   <div class="left-block">
                      ...
                      <div class="right-block">
                          <h5>
                           <a class="product-name font-4" target="_blank" href="/videoCards/{{ $value -> id }}" title="{{ $value -> title }}">
                              ...
                              <div class="product-flags">
                                ...
                                <div class="product-more-options">
                                    <div class="read-more-container">
                                        <a class="button read-more-button btn btn-default" target="_blank" href="/videoCards/{{ $value -> id }}">
