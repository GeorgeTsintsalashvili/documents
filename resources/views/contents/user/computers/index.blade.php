	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="font-mtavruli p-abs">სისტემური ბლოკები</h4>
				<div class="options">
        ...
        <div class="tab-pane" id="add-product">
		         ...
		         <div class="col-sm-2">
		           <input type="text" class="form-control" name="gpuTitle">
		         </div>

		         <label class="col-sm-1 control-label font-4">VRAM</label>
		         <div class="col-sm-2">
		           <input type="text" data-reg-exp="^(0|[1-9]\d*)$" class="form-control" name="videoMemory" value="0">
		         </div>

						 <label class="col-sm-1 control-label font-4">Graphics</label>
						 <div class="col-sm-2">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control" data-reg-exp="^([1-9]\d*)$" name="memory">
							</div>

							<label class="col-sm-1 control-label font-4">HDD</label>
							<div class="col-sm-2">
								<input type="text" class="form-control" data-reg-exp="^(0|[1-9]\d*)$" name="hardDiscDriveCapacity">
							</div>

							<label class="col-sm-1 control-label font-4">SSD</label>
							<div class="col-sm-2">
								<input type="text" class="form-control" data-reg-exp="^(0|[1-9]\d*)$" name="solidStateDriveCapacity">
							</div>

						 <label class="col-sm-1 control-label font-4">System</label>
 						 <div class="col-sm-2">
 								<select name="seriesId" class="form-select wpr-100">
 									 @foreach($systems as $system)
 										<option class="font-4" value="{{ $value -> id }}">{{ $system -> seriesTitle }}</option>
 									 @endforeach
 								</select>
 						 </div>
