	...
	<div class="col-xs-6">
		<div class="panel panel-default">
          ...
          @foreach($formFactors as $value)
              ...
              <!--- Title field --->
							<td>
								<input data-parameter-name="hdd-ff-title" type="text" value="{{ $value -> formFactorTitle }}" class="no-border transparent-bg-color font-4 field">
							</td>
       ...
       <form action="{{ route('hddffStore') }}" method="post" class="form-horizontal row-border data-form" enctype="multipart/form-data">
          ...
          <div class="col-sm-3">
            <input type="submit" class="btn-primary btn font-4" value="დამატება">
 					...
 					<div class="col-sm-4">
 						<input name="hdd-ff-title" type="text" class="form-control font-4" placeholder="დასახელება">
 					</div>
        </div>
      </form>
