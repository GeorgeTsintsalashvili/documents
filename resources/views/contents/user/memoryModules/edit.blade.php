          ...
          <div class="form-group">
             ...
             <div class="col-sm-2">
               <div class="input-group font-4">
                 <span class="input-group-addon icheck">
                   <input type="checkbox" name="isCouple" {{ $product -> isCouple ? "checked" : null }}>
                 </span>
           ...
           <div class="form-group">
             ...
             <div class="input-group font-4 checkbox-select-group">
               <span class="input-group-addon icheck">
                 <input type="checkbox" name="destination" {{ $product -> destination == 2 ? "checked" : null }}>
               </span>
            ...
            <div class="col-sm-2">
               <input type="text" name="frequency" class="form-control" value="{{ $product -> frequency }}">
            </div>
