	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="font-mtavruli p-abs">ოპერატიული მეხსიერების მოდულები</h4>
				<div class="options">
			...
			<div class="panel-body">
	           ...
	           @foreach($items as $value)
	 						...
	 						<tr data-record-id="{{ $value -> id }}">
	 							...
	 							<td class="preview-image">
	 								<img src="/images/memoryModules/main/preview/{{ $value -> mainImage }}" class="invoice-image" data-uuid="{{ $value -> uuid }}">
	 							</td>
	         ...
	         <div data-page-key="{{ $paginationKey }}" data-current-page="{{ $paginator -> currentPage }}" class="clearfix pagination-column col-sm-12">
	           ...
	           <div class="col-sm-4">
	             ...
	             <option class="font-4" value="0">ყველა ტიპი</option>
	              @foreach($types as $type)
	                <option value="{{ $type -> id }}" {{ $selectedTypeId == $type -> id ? "selected" : null }} class="font-4"> {{ $type -> typeTitle }} </option>
	              @endforeach
	           </select>
  			       ...
  			       <input type="text" id="touchspin1" name="price" class="form-control">
 						...
 						<div class="form-group">
							...
							<div class="col-sm-2">
								<div class="input-group font-4">
									<span class="input-group-addon icheck">
										<input type="checkbox" name="isCouple">
									</span>
									<input type="text" name="quantity" data-reg-exp="^(0|[1-9]\d*)$" class="form-control">
								</div>
							</div>
							...
							<div class="col-sm-2">
								...
								<div class="input-group font-4 checkbox-select-group">
									<span class="input-group-addon icheck">
							...
							<div class="col-sm-2">
								<input type="text" name="capacity" data-reg-exp="^([1-9]\d*)$" class="form-control">
							</div>

							<label class="col-sm-1 control-label font-4">სიხშირე</label>
							<div class="col-sm-2">
								<input type="text" name="frequency" data-reg-exp="^([1-9]\d*)$" class="form-control">
							</div>
