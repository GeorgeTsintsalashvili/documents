	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="font-mtavruli p-abs">მონიტორები</h4>
				<div class="options">
	           ...
	           @foreach($items as $value)
	 						...
	 						<tr data-record-id="{{ $value -> id }}">
	 							...
	 							<td class="preview-image">
	 								<img src="/images/monitors/main/preview/{{ $value -> mainImage }}" class="invoice-image" data-uuid="{{ $value -> uuid }}">
	 							</td>
								...
								<td class="text-center">
								 ...
								 <a class="add-warranty" href="{{ $value -> uuid }}" data-system-part="0" data-warranty-page="computer" data-warranty="{{ $value -> warranty }}" style="line-height: 1">
				 ...
				 <div class="tab-pane" id="add-product">
  			       ...
  			       <input type="text" id="touchspin1" name="price" class="form-control">
 						...
 						<div class="form-group">
							...
							<label class="col-sm-1 control-label font-4">დიაგონალი</label>
							<div class="col-sm-2">
								<input type="text" class="form-control" data-reg-exp="^\d+(\.\d{1,2})?$" name="diagonal">
							</div>

							<label class="col-sm-1 control-label font-4">სიხშირე</label>
							<div class="col-sm-2">
								<input type="text" class="form-control" data-reg-exp="^([1-9]\d*)$" name="refreshRate">
							</div>
