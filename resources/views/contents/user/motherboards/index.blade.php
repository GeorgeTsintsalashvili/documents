	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="font-mtavruli p-abs">დედაპლატები</h4>
				<div class="options">
	           ...
	           @foreach($items as $value)
	 						...
	 						<tr data-record-id="{{ $value -> id }}">
	 							...
	 							<td class="preview-image">
	 								<img src="/images/motherboards/main/preview/{{ $value -> mainImage }}" class="invoice-image" data-uuid="{{ $value -> uuid }}">
	 							</td>
	             ...
	             <div class="input-group">
	               ...
	               <input id="search-field" type="text" autocomplete="off" data-control-parameter-name="search-query" value="{{ $searchQuery }}" class="form-control font-4 control-field" placeholder="საძიებო სიტყვა">
	 					...
	 					<select class="control-data-list col-sm-2 p-n mr20" data-control-parameter-name="{{ $manufacturersKey }}">
	 						<option class="font-4" value="0">ყველა ბრენდი</option>
	 						 @foreach($manufacturers as $manufacturer)
	 							 <option value="{{ $manufacturer -> id }}" {{ $selectedManufacturerId == $manufacturer -> id ? "selected" : null }} class="font-4"> {{ $manufacturer -> manufacturerTitle }} </option>
	 						 @endforeach
	 					</select>
				 ...
				 <div class="tab-pane" id="add-product">
  			       ...
  			       <input type="text" id="touchspin1" name="price" class="form-control">
							...
							<div class="col-sm-2">
 								 <select name="socketId" class="form-select wpr-100">
 									 @foreach($sockets as $value)
 										 <option class="font-4" value="{{ $value -> id }}">{{ $value -> socketTitle }}</option>
 									 @endforeach
 								 </select>
							</div>
							...
							<div class="col-sm-2">
 								 <select name="chipsetId" class="form-select wpr-100">
 									 @foreach($chipsets as $value)
 										 <option class="font-4" value="{{ $value -> id }}">{{ $value -> chipsetTitle }}</option>
 									 @endforeach
 								 </select>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control" data-reg-exp="^([1-9]\d*)$" name="maxMemory">
							</div>

							<label class="col-sm-1 control-label font-4">სლოტები</label>
 							<div class="col-sm-2">
 								<input type="text" class="form-control" data-reg-exp="^([1-9]\d*)$" name="ramSlots" value="2">
 							</div>
							...
							<label class="col-sm-1 control-label font-4">RAM ტიპი</label>
							<div class="col-sm-2">
