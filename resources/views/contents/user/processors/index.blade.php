	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="font-mtavruli p-abs">პროცესორები</h4>
				<div class="options">
			...
			<div class="panel-body">
	           ...
	           @foreach($items as $value)
	 						...
	 						<tr data-record-id="{{ $value -> id }}">
	 							...
	 							<td class="preview-image">
	 								<img src="/images/processors/main/preview/{{ $value -> mainImage }}" class="invoice-image" data-uuid="{{ $value -> uuid }}">
	 							</td>

	 							<td>
	 								<input data-parameter-name="title" type="text" value="{{ $value -> title }}" class="no-border transparent-bg-color field">
	 							</td>
	         ...
	         <div data-page-key="{{ $paginationKey }}" data-current-page="{{ $paginator -> currentPage }}" class="clearfix pagination-column col-sm-12">
	           ...
	           <select class="control-data-list col-sm-2 p-n mr20" data-control-parameter-name="{{ $systemsKey }}">
	             <option class="font-4" value="0">ყველა სისტემა</option>
	              @foreach($systems as $system)
	                <option value="{{ $system -> id }}" {{ $selectedSystemId == $system -> id ? "selected" : null }} class="font-4"> {{ $system -> seriesTitle }} </option>
	              @endforeach
	           </select>
  			       ...
  			       <input type="text" id="touchspin1" name="price" class="form-control">
 						...
 						<div class="form-group">
							...
							<label class="col-sm-1 control-label font-4">სიხშირე</label>
 							<div class="col-sm-2">
 								<input type="text" class="form-control" data-reg-exp="^([1-9]\.?\d*)$" name="clockSpeed">
 							</div>

							<label class="col-sm-1 control-label font-4">ბირთვები</label>
 							<div class="col-sm-2">
 								<input type="text" class="form-control" data-reg-exp="^([1-9]\d*)$" name="cores">
 							</div>
