	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="font-mtavruli p-abs">SSD მეხსიერება</h4>
				<div class="options">
	           ...
	           @foreach($items as $value)
	 						...
	 						<tr data-record-id="{{ $value -> id }}">
	 							...
	 							<td class="preview-image">
	 								<img src="/images/solidStateDrives/main/preview/{{ $value -> mainImage }}" class="invoice-image" data-uuid="{{ $value -> uuid }}">
	 							</td>
				 ...
				 <div class="tab-pane" id="add-product">
  			       ...
  			       <input type="text" id="touchspin1" name="price" class="form-control">
 		                ...
 		                <option class="font-4" value="{{ $value -> id }}">{{ $value -> formFactorTitle }}</option>
							...
							<label class="col-sm-1 control-label font-4">ტექნ-გია</label>
							<div class="col-sm-2">
 								<select name="technologyId" class="form-select wpr-100">
 									@foreach($technologies as $value)
 		                <option class="font-4" value="{{ $value -> id }}">{{ $value -> technologyTitle }}</option>
 									@endforeach
 								</select>
 							</div>
