	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="font-mtavruli p-abs">უწყვეტი კვების წყარო</h4>
				<div class="options">
	           ...
	           @foreach($items as $value)
	 						...
	 						<tr data-record-id="{{ $value -> id }}">
	 							...
	 							<td class="preview-image">
	 								<img src="/images/uninterruptiblePowerSupplies/main/preview/{{ $value -> mainImage }}" class="invoice-image" data-uuid="{{ $value -> uuid }}">
	 							</td>
        ...
        <div class="tab-pane" id="add-product">
					...
					<form action="{{ route('upsStore') }}" method="POST" class="form-horizontal row-border store-form" enctype="multipart/form-data">
					 ...
					 <div class="form-group">
						 ...
						 <label class="col-sm-1 control-label font-4">სიმძლავრე</label>
						 <div class="col-sm-2">
							 <input type="text" class="form-control" data-reg-exp="^([1-9]\d*)$" name="power">
						 </div>
