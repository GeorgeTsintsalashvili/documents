	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="font-mtavruli p-abs">ვიდეო ბარათები</h4>
				<div class="options">
	           ...
	           @foreach($items as $value)
	 						...
	 						<tr data-record-id="{{ $value -> id }}">
	 							...
	 							<td class="preview-image">
	 								<img src="/images/videoCards/main/preview/{{ $value -> mainImage }}" class="invoice-image" data-uuid="{{ $value -> uuid }}">
	 							</td>
	           ...
	           <div class="col-sm-3">
	             ...
	             <option class="font-4" value="0">ყველა ბრენდი</option>
	              @foreach($manufacturers as $manufacturer)
	                <option value="{{ $manufacturer -> id }}" {{ $selectedManufacturerId == $manufacturer -> id ? "selected" : null }} class="font-4"> {{ $manufacturer -> videoCardManufacturerTitle }} </option>
	              @endforeach
	           </select>
				 ...
				 <div class="tab-pane" id="add-product">
  			       ...
  			       <input type="text" id="touchspin1" name="price" class="form-control">
 						...
 						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control" data-reg-exp="^([1-9]\d*)$" name="minPower">
							</div>

							<label class="col-sm-1 control-label font-4">ინტერფეისი</label>
 							<div class="col-sm-2">
 								<input type="text" class="form-control" data-reg-exp="^([1-9]\d*)$" name="memoryBandwidth">
 							</div>
						...
						<div class="form-group">
							...
							<label class="col-sm-1 control-label font-4">პროცესორი</label>
							<div class="col-sm-2">
							...
							<label class="col-sm-1 control-label font-4">VRAM ტიპი</label>
							<div class="col-sm-2">
