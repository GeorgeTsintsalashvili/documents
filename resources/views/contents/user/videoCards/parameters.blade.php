	...
	<div class="col-xs-6">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="font-mtavruli">მწარმოებლები</h4>
			</div>
				...
				<table class="table table-hover mb1" data-update-route="{{ route('vcManufacturerUpdate') }}">
					...
					@foreach($videoCardsManufacturers as $value)
						...
						<tr data-record-id="{{ $value -> id }}">
							...
							<!--- Title field --->
							<td>
								<input data-parameter-name="video-card-manufacturer-title" type="text" value="{{ $value -> videoCardManufacturerTitle }}" class="no-border transparent-bg-color font-4 field">
							</td>
            ...
            @endif
			 ...
			 <form action="{{ route('vcManufacturerStore') }}" method="post" class="form-horizontal row-border data-form" enctype="multipart/form-data">
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input name="video-card-manufacturer-title" type="text" class="form-control font-4" placeholder="დასახელება">
					</div>
				</div>
			</form>
		...
		<div class="panel-body">
			<table class="table table-hover mb1" data-update-route="{{ route('vcMemoryTypeUpdate') }}">
				...
				@foreach($videoMemoryTypes as $value)
					...
					<tr data-record-id="{{ $value -> id }}">
						...
						<td>
							<input data-parameter-name="video-memory-type-title" type="text" value="{{ $value -> typeTitle }}" class="no-border transparent-bg-color font-4 field">
						</td>
		 ...
		 <form action="{{ route('vcMemoryTypeStore') }}" method="post" class="form-horizontal row-border data-form" enctype="multipart/form-data">
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input name="video-memory-type-title" type="text" class="form-control font-4" placeholder="დასახელება">
				</div>
			</div>
		</form>
...
<div class="row">
	...
	<div class="col-xs-6">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="font-mtavruli">სისტემური ბლოკის გრაფიკა</h4>
			</div>
			<div class="panel-body">
          ...
          @foreach($systemBlockGraphics as $value)
              ...
              <!--- Title field --->
							<td>
								<input data-parameter-name="computer-graphics-type-title" type="text" value="{{ $value -> graphicsTitle }}" class="no-border transparent-bg-color font-4 field">
							</td>
       ...
       <form action="{{ route('graphicsTypeStore') }}" method="post" class="form-horizontal row-border data-form" enctype="multipart/form-data">
          ...
          <div class="col-sm-3">
            <input type="submit" class="btn-primary btn font-4" value="დამატება">
 					...
 					<div class="col-sm-6">
 						<input name="computer-graphics-type-title" type="text" class="form-control font-4" placeholder="დასახელება">
 					</div>
        </div>
      </form>
	...
	<div class="col-xs-6">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="font-mtavruli">გრაფიკული პროცესორები</h4>
			</div>
			<div class="panel-body">
				<table class="table table-hover mb1" data-update-route="{{ route('gpuManufacturerUpdate') }}">
					...
					@foreach($gpuManufacturers as $value)
						...
						<tr data-record-id="{{ $value -> id }}">
							...
							<!--- Title field --->
							<td>
								<input data-parameter-name="gpu-manufacturer-title" type="text" value="{{ $value -> gpuTitle }}" class="no-border transparent-bg-color font-4 field">
							</td>
			 ...
			 <form action="{{ route('gpuManufacturerStore') }}" method="post" class="form-horizontal row-border data-form" enctype="multipart/form-data">
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input name="gpu-manufacturer-title" type="text" class="form-control font-4" placeholder="დასახელება">
					</div>
				</div>
			</form>
