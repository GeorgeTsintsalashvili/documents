   ...
   <div class="row">
     ...
     <div class="col-md-8">
      <ul class="float-right">
        <li>
          <b class="font-4">ტელეფონი: </b>
          <span> {{ $contact -> phone }} </span>
        </li>
        <li>
          <b class="font-4">ელ. ფოსტა: </b>
          <span> {{ $contact -> email }} </span>
        </li>
        <li>
          <b class="font-4"> მისამართი: </b>
          <span> {{ $contact -> address }} </span>
        </li>
        <li>
          <b class="font-4"> საიტის მისამართი: </b>
   ...
   <div class="row">
    <div class="col-md-12">
      <div class="warranty-rules-container">
       ...
       <h3 class="rules-title font-4 text-center"> საგარანტიო ფურცელი </h3>

       <p class="warranty-rules font-4">
...
@font-face {
  font-family: font-1;
  src: url("/fonts/various/bpg_glaho.ttf");
}

@font-face {
  font-family: font-2;
  src: url("/fonts/various/bpg_nino_mtavruli_normal.ttf");
}

@font-face {
  font-family: font-3;
  src: url("/fonts/various/bpg_nino_mtavruli_bold.ttf");
}

@font-face {
  font-family: font-4;
  src: url("/fonts/various/bpg_mrgvlovani_2009.ttf");
}
