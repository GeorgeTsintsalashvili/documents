...
function refreshPage(method, address, formData = {})
{
    ...
    let successCallback = function(data){
      ...
      localStorage.setItem("pageAddress", $(this).attr("url"));

      localStorage.setItem("pageContent", data);
...
function runSearch()
{
  ...
  if(inputText.indexOf(" ") != 0)
  {
    ...
    let inputText = $(searchField).val();

    $(searchField).val("").val(inputText).focus();
  }
}
...
$("input.control-field").keyup(runSearch);
